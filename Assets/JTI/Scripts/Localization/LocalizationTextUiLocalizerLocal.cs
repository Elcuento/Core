...
{
    public class LocalizationTextUiLocalizerLocal : MonoBehaviour
    {
        [SerializeField] private LocalizationManagerLocal _managerLocal;
       ...
       [SerializeField] private bool _upper;
        ...
        public void Refresh()
        {
            if (_managerLocal != null)
            {
              //  Debug.Log(_key);
                _text.text = $"{_beforeText}{_managerLocal.GetLocale(_text, _key, _outlined)}{_afterText}";
