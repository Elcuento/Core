...
namespace JTI.Scripts.Managers
{
    ...
    {
        public Action<SystemLanguage> OnUpdateLanguageEvent;
        ...
        protected override void OnAwaken()
        {
            ...
            {
                LocalizationData = new LocalizationData() { Values = new List<LocalizationLanguage>() };
            }
        ...
        public void ChangeLanguage(SystemLanguage language, bool force = false)
        {
            ...
            OnUpdateLanguageEvent?.Invoke(language);
            /*  EventManager.Instance.Publish(new SettingsLanguageChangeEvent()
              {
                  Language = language
              });*/
        }
